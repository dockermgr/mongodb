...
# @@Created          :  Monday, Oct 24, 2022 18:29 EDT
# @@File             :  install.sh
# @@Description      :  
...
# Defaults variables
APPNAME="mongodb"
INSTDIR="$HOME/.local/share/CasjaysDev/dockermgr/mongodb"
APPDIR="$HOME/.local/share/srv/docker/mongodb"
DATADIR="$HOME/.local/share/srv/docker/mongodb/rootfs"
...
CONTAINER_HTTP_PORT="19214:80"
CONTAINER_HTTPS_PORT=""
CONTAINER_SERVICE_PORT=""
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Add Add sevicee port [port] or [port:port] - LISTEN will be added if defined [DEFINE_LISTEN]
CONTAINER_ADD_CUSTOM_PORT="27017"
