...
# Defaults variables
APPNAME="mongodb"
INSTDIR="$HOME/.local/share/dockermgr/mongodb"
APPDIR="$HOME/.local/share/srv/docker/mongodb"
DATADIR="$HOME/.local/share/srv/docker/mongodb/files"
...
HUB_URL="casjaysdevdocker/mongodb:latest"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
if [ -z "$HUB_URL" ] || [ "$HUB_URL" = "hello-world" ] || echo "$HUB_URL" | grep -q "mongodb"; then
