...
REPO="${DOCKERMGRREPO:-https://github.com/$SCRIPTS_PREFIX}/mongodb"
APPVERSION="$(__appversion "$REPO/raw/$REPO_BRANCH/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="mongodb"
export INSTDIR="$HOME/.local/share/CasjaysDev/$SCRIPTS_PREFIX/mongodb"
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set container hostname and domain - Default: [mongodb.$SET_HOST_FULL_NAME] [$SET_HOST_FULL_DOMAIN]
CONTAINER_HOSTNAME=""
